...
################################################################################
## Form generated from reading UI file 'InputChoice.ui'
##
...
class Ui_Input(object):
    def setupUi(self, SortingApp):
        ...
        self.algo_compare_layout = QVBoxLayout()
        self.algo_compare_layout.setObjectName(u"algo_compare_layout")
        self.algo1_label = QLabel(self.centralwidget)
        self.algo1_label.setObjectName(u"algo1_label")

        self.algo_compare_layout.addWidget(self.algo1_label)
        ...
        self.algo_compare_layout.addWidget(self.algo1_combo)

        self.algo2_label = QLabel(self.centralwidget)
        self.algo2_label.setObjectName(u"algo2_label")

        self.algo_compare_layout.addWidget(self.algo2_label)
        ...
        self.algo_compare_layout.addWidget(self.algo2_combo)


        self.left_layout.addLayout(self.algo_compare_layout)
